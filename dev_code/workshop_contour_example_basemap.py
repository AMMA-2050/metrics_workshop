...
def workshop_contour_example_basemap(a):
   ...
   m = bm.Basemap(projection='cyl',llcrnrlat = 8.0, urcrnrlat = 16.0, llcrnrlon = -20.0, urcrnrlon = 20.0,  resolution = 'c')
   m.drawcoastlines(linewidth = 2)
   m.drawcountries(linewidth = 1)
   plt.text(-21.5,15,'(a)')
   plt.subplot(3,1,2)
   fig2 = plt.contourf(ltd,lat,mydata[:],levs)
   m = bm.Basemap(projection='cyl',llcrnrlat = 8.0, urcrnrlat = 16.0, llcrnrlon = -20.0, urcrnrlon = 20.0,  resolution = 'l')
   m.drawcoastlines(linewidth = 2)
   m.drawcountries(linewidth = 1)
   plt.text(-21.5,15,'(b)')
   plt2_ax = ax1.gca()     
   ...
   m = bm.Basemap(projection='cyl',llcrnrlat = 8.0, urcrnrlat = 16.0, llcrnrlon = -20.0, urcrnrlon = 20.0,  resolution = 'f')
   m.drawcoastlines(linewidth = 2)
   m.drawcountries(linewidth = 1)
   plt.text(-21.5,15,'(c)')
   plt3_ax = ax1.gca()     
   ...
   plt.savefig('matplot_contour_with_basemap.png')
   plt.show()
    
if "__name__" == "__workshop_contour_example_basemap__":
 workshop_contour_example_basemap(a)    