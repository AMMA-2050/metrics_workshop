...
def workshop_scatter_example_full():
    ...
    plt.scatter(list1[:], list2[:], c='r', marker='D', s=100, label='correl = ' + str(correl1))  # plot basic scatter
    plt.scatter(list1[:], list3[:], c='purple', marker='H', s=150, label='correl = ' + str(correl2))
    ...
    plt.savefig('/nfs/see-fs-01_teaching/earv057/metrics_workshop/test_corrrelation.png')
    plt.show()  # display
