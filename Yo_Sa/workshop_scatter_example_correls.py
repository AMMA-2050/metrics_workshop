...
def workshop_scatter_example_correls():
    ...
    list3 = [4, 2, 1, 7, 8, 3, 4, 12, 9,20] # yet some other data
    ...
    plt.scatter(list1[:], list2[:], c='r', marker='^', s=100, label='Boys correl = ' + str(correl1))  # plot basic scatter
    plt.scatter(list1[:], list3[:], c='k', marker='*', s=150, label='Girls correl = ' + str(correl2))
