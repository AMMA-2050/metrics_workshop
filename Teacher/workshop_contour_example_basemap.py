...
### This plot could take a while! So be patient :)/nfs/see-fs-01_teaching/earv061

def workshop_contour_example_basemap():
    # Read the data, adapt this path to your path if necessary
    mydata = gent('/nfs/see-fs-01_teaching/earv061/metrics_workshop/example_code/TRMM_v7_Marteau_onsets_1998_dry_spell_30.csv',
                  delimiter=',')

    # Shape of the data
    print(mydata.shape)

    ltd = np.linspace(-20, 20, 150)
